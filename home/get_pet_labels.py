...
# Retrieve the filenames from folder pet_images/
    filename_list = [f for f in listdir(str(image_dir)) if not f.startswith('.')]  #using list comprehension to skip hidden files 
...
# Sets string to lower case letters
    for specie in filenames:
        low_pet_image = specie.lower()
...
# Prints resulting pet_name
        print("\nFilename=", specie, "   Label=", pet_name)
    
    
    for idx in range(0, len(filenames), 1):   #I have used list comprehension to skip hidden files above when I retrieved file name list from folder
